...
<input type="hidden" name="_token" value="',csrf_token(),'"><input type="hidden" name="token" value="',$tg,'">
</form>
...
create_sql($R,$Ga,$Vf){global$h;$J='';$nf=array();$Af=array();$Sf=table_status($R);if(is_view($Sf)){$Xg=adm_view($R);return
